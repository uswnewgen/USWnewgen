...
## 👥 ข้อมูลทีม
- **ชื่อทีม:** __USW new gen_____________
- **เลขทีม:** XX
- **ชื่อบอร์ด:** USWnewgen
- **สมาชิก + บทบาท (3H):**
  - 🛠️ **Hacker** (เทคนิค: ต่อบอร์ด/เก็บ data/train/deploy): _____ นาอีมะห์ สาเม๊าะ __________
  - 🎨 **Hipster** (ผู้ใช้: output ที่คนเข้าใจ/รูปแบบใช้งาน): ____รุตียา ปุโรง___________
  - 📣 **Hustler** (คุณค่า: ปัญหา/ผู้ใช้/เล่าเดโม่): _______อามีรา ยาสุโก๊ะ ________
...
**บ่าย — เทรนจริง**
- [ ] input ที่เลือกเทรน: ____ กล้อง ___________
...
**1. ทีมสอน AI ให้ทำอะไร? (ปัญหา + ผู้ใช้)** ___ ให้จับภาพวัตถุกับเทรนเอไอ____________
**2. model ทำได้ดีแค่ไหน F1 ต่ำสุดที่ class ไหน ได้  ___ได้ F1 ที่คลาสแรกพราะ ยังไม่ได้เทรนเยอะและอาจจะมีปัญหาเรื่องการเชื่อมเน็ตเบยทำให้ล้าช้า
**3. ถ้ามีเวลาอีก 1 ชม. จะแก้อะไรก่อน?** _____อยากแก้ไขเรื่องอินเตอร์เน็ตค่ะ อยากให้สัญญาณเร็วกว่านี้ __________
## 🔗 ลิงก์
- Edge Impulse project: _____ ภาพ __________
